Vue.component('app-website', {
    ...
    <section class="websitePage vh-100">
        <nav class="navbar navbar-expand-lg navbar-light" style="padding: 3rem 10rem;">
            <a class="navbar-brand" href="#"><h3>/*JERYL TEO*/</h3></a>
        ...
        <main class="webHero row" style="margin: 7rem 10rem 0rem 7rem;">
        ...
        <section class="webAbout" id="aboutme" style="margin-top: 15rem;">
            <article class="row">
                <div class="col-4 offset-1">
                    <img style="border-radius: 1rem; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.16); max-height: 750px;" class="img-fluid" src="/images/jeryl_1.jpeg" alt="jeryl">
                </div>
        ...
        <section class="webWorks vh-100 row" id="myworks" style="margin-top: 10rem; padding: 0 10rem; color: #eeeeee; max-width: 100vw;">
            <article class="col-12" style="margin-top: 5rem;">
                <h2>//My Works</h2>
            </article>
            ...
            <article class="col-12 col-lg-8 d-flex">
                <h2 class="ml-auto align-self-center">// Check out more of my works <i class="ml-5 fas fa-chevron-right"></i></h2>
            </article>

            <section class="webServices col-12" style="margin-top: 10rem; padding: 5rem;" id="myservices">
                <h2 class="text-center mt-5">//My Services</h2>
                <section class="row mt-5">
                    <article class="col-12 col-lg-4 d-flex flex-column align-items-center">
                        <i style="color: #52575D;" class="fas fa-bezier-curve fa-9x"></i>
                        <h3 class="text-center mt-5">Designing &<br>Illustrating</h3>
                    </article>
                    <article class="col-12 col-lg-4 d-flex flex-column align-items-center">
                        <i style="color: #52575D;" class="fab fa-chrome fa-9x"></i>
                        <h3 class="text-center mt-5">Front End<br>Development</h3>
                    </article>
                    <article class="col-12 col-lg-4 d-flex flex-column align-items-center">
                        <i style="color: #52575D;" class="fas fa-sitemap fa-9x"></i>
                        <h3 class="text-center mt-5">Back End<br>Development</h3>
                    </article>
                </section>
            </section>

            <section class="col-10 offset-1" id="contactme" style="margin-top: 10rem; color: #222222;">
                <h2>//Contact Me</h2>
            ...
            <section id="myfooter" style="width: 100vw; background-color: #41444B; color: #eeeeee;" class="row p-5">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <a class="text-light mr-4" href="https://www.facebook.com/jerylteoSI"><i class="fab fa-facebook fa-3x"></i></a>
                        <a class="text-light mr-4" href="https://www.instagram.com/jerylteo.si/"><i class="fab fa-instagram fa-3x mx-3"></i></a>
                        <a class="text-light mr-5" href="https://www.linkedin.com/in/jerylteo/"><i class="fab fa-linkedin-in fa-3x"></i></a>
                ...
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <nav class="navbar navbar-dark">
                        <ul class="navbar-nav" style="flex-direction: row;">
                            <li class="nav-item mr-5">
                                <a style="color: #eeeeee !important;" @click.prevent="router.push('/')" class="nav-link" href="#"><h5>Landing Page</h5></a>
                            </li>
                            <li class="nav-item mr-5">
                                <a style="color: #eeeeee !important;" class="nav-link" href="#aboutme"><h5>About Me</h5></a>
                            </li>
                            <li class="nav-item mr-5">
                                <a style="color: #eeeeee !important;" class="nav-link" href="#"><h5>My Works</h5></a>
                            </li>
                            <li class="nav-item mr-5">
                                <a style="color: #eeeeee !important;" class="nav-link" href="#"><h5>My Services</h5></a>
                            </li>
                            <li class="nav-item">
                                <a style="color: #eeeeee !important;" class="nav-link" href="#"><h5>Contact Me</h5></a>
                            </li>
                        </ul>
                    </nav>
